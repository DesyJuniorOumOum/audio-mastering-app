...
const resources = {
  fr: {
    translation: {
      subtitle: "Sublimez vos pistes audio instantanément grâce à l'algorithme intelligent d'Auphonic",
      ...
      btnMastered: "✨ Masterisé (Auphonic)",
  ...
  en: {
    translation: {
      subtitle: "Enhance your audio tracks instantly using Auphonic's intelligent algorithm",
